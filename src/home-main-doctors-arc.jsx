        ...
        <div id="home-main-doctors-arc">
            <div className="container">
                <div className="row w-100 p-0 m-0">
                    {doctorsInfoContext.doctors.slice(0,5).map((item,index)=>{
                        return(
                            <div key={index} className="card">
                                ...
                                <Link to={`doctorsArchive/${item.name}`} className="card-link">
                                    <span>
                ...
                <div className="row w-100 p-0 see-all-row">
                    <Link to={`/doctorsArchive`}>مشاهده تمام پزشکان تپش</Link>
                </div>
            </div>
        </div>
    );
